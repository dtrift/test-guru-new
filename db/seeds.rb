# users = User.create!([
#   {first_name: 'Tim', last_name: 'G', email: 'tn.timur.g@gmail.com', password: 'PaS$w0Rd', type: 'Admin'}
#   ])
...
tests = Test.create!([
  ...
  {title: 'Ruby level 2', level: 2, category_id: categories[1].id, user_id: users[0].id},
  {title: 'Rails level 2', level: 2, category_id: categories[1].id, user_id: users[0].id},
  {title: 'HTML level 2', level: 2, category_id: categories[0].id, user_id: users[0].id},
  {title: 'CSS level 2', level: 2, category_id: categories[0].id, user_id: users[0].id}
  ])
